...
export const DICIONARIO: Traducoes = {
  ...
  "Contas a pagar e receber, vencimentos e fluxo de caixa. O sistema registra; não movimenta dinheiro.": { es: "Cuentas por pagar y cobrar, vencimientos y flujo de caja. El sistema registra; no mueve dinero." },
  "Resumo financeiro": { es: "Resumen financiero" },
  "A receber": { es: "Por cobrar" },
  "A pagar": { es: "Por pagar" },
  "Saldo previsto": { es: "Saldo previsto" },
  "Saldo realizado": { es: "Saldo realizado" },
  "Vencidos": { es: "Vencidos" },
  "Novo lançamento": { es: "Nuevo registro" },
  "Conta a receber": { es: "Cuenta por cobrar" },
  "Conta a pagar": { es: "Cuenta por pagar" },
  "Vencimento": { es: "Vencimiento" },
  "Observações (opcional)": { es: "Observaciones (opcional)" },
  "Registrar": { es: "Registrar" },
  "Lançamentos": { es: "Registros" },
  "Baixados": { es: "Confirmados" },
  "Nenhum lançamento neste filtro.": { es: "Ningún registro en este filtro." },
  "Receber": { es: "Cobrar" },
  "Pagar": { es: "Pagar" },
  "proposto por agente": { es: "propuesto por agente" },
  "registro manual": { es: "registro manual" },
  "Baixado": { es: "Confirmado" },
  "Confirmar baixa": { es: "Confirmar registro" },
  "Confirmação humana obrigatória.": { es: "Confirmación humana obligatoria." },
  "Pagamentos, reembolsos, descontos, transferências e compromissos financeiros não são executados pelo agente. A fila de propostas do agente entra na próxima fase.": { es: "El agente no ejecuta pagos, reembolsos, descuentos, transferencias ni compromisos financieros. La cola de propuestas del agente entra en la próxima fase." },
  "Informe um valor maior que zero.": { es: "Ingresa un valor mayor que cero." },
  "Confirmar a baixa? Isso declara que o valor foi realizado.": { es: "¿Confirmar el registro? Esto declara que el valor fue realizado." },
  "Cancelar sem apagar a trilha?": { es: "¿Cancelar sin borrar el historial?" },
  "Reabrir este lançamento?": { es: "¿Reabrir este registro?" },
  ...
  "Nome — informe como este agente será identificado.": { es: "Nombre: indica cómo se identificará a este agente." },
  "Ordem de preferência — use um número entre 0 e 1000.": { es: "Orden de preferencia: usa un número entre 0 y 1000." },
  "Instruções — descreva como o agente deve atender.": { es: "Instrucciones: describe cómo debe atender el agente." },
  "Modelo — escolha a inteligência artificial usada no atendimento.": { es: "Modelo: elige la inteligencia artificial que se usará en la atención." },
  "Chave de acesso — selecione ou cadastre uma credencial válida.": { es: "Clave de acceso: selecciona o registra una credencial válida." },
  "Número conectado — escolha o WhatsApp que este agente atenderá.": { es: "Número conectado: elige el WhatsApp que atenderá este agente." },
  "Capacidades — reduza a seleção até o limite permitido.": { es: "Capacidades: reduce la selección hasta el límite permitido." },
  "Concluir configuração": { es: "Finalizar configuración" },
  "Tudo pronto para concluir a configuração": { es: "Todo listo para finalizar la configuración" },
  "Faltam": { es: "Faltan" },
  "etapa": { es: "paso" },
  "etapas": { es: "pasos" },
  "para concluir": { es: "para finalizar" },
  "Este rascunho fica salvo mesmo se você sair desta página. Você pode retomá-lo ou apagá-lo pela lista de agentes.": { es: "Este borrador queda guardado aunque salgas de esta página. Puedes retomarlo o eliminarlo desde la lista de agentes." },
  "Resolva os itens abaixo para liberar o salvamento.": { es: "Resuelve los elementos siguientes para habilitar el guardado." },
  "Salvando rascunho…": { es: "Guardando borrador…" },
  "Falha ao salvar automaticamente": { es: "No se pudo guardar automáticamente" },
  "Rascunho salvo": { es: "Borrador guardado" },
  "Configuração incompleta": { es: "Configuración incompleta" },
  "Seu progresso foi salvo. Abra o rascunho para concluir ou use o menu para apagá-lo.": { es: "Tu progreso fue guardado. Abre el borrador para finalizarlo o usa el menú para eliminarlo." },
  "Apagar rascunho": { es: "Eliminar borrador" },
  "O rascunho sai da lista ativa. A remoção é segura e fica preservada no histórico de auditoria.": { es: "El borrador sale de la lista activa. La eliminación es segura y queda registrada en el historial de auditoría." },
  "Conectar agente externo (MCP)": { es: "Conectar agente externo (MCP)" },
  "Já possui um agente em outra nuvem ou VPS?": { es: "¿Ya tienes un agente en otra nube o VPS?" },
  "Conecte-o pelo MCP com um token exclusivo desta organização. Os escopos limitam leitura e escrita, e o agente externo nunca escolhe outra organização pelo corpo da requisição.": { es: "Conéctalo por MCP con un token exclusivo de esta organización. Los alcances limitan la lectura y la escritura, y el agente externo nunca elige otra organización desde el cuerpo de la solicitud." },
  "Conectar um agente externo por MCP": { es: "Conectar un agente externo por MCP" },
  "Use o endereço HTTPS desta instalação seguido de": { es: "Usa la dirección HTTPS de esta instalación seguida de" },
  "Crie abaixo um token exclusivo para a organização e selecione somente os escopos necessários. O segredo aparece uma única vez.": { es: "Crea abajo un token exclusivo para la organización y selecciona solamente los alcances necesarios. El secreto aparece una sola vez." },
  "Para leitura, habilite mcp:read. Para ações, acrescente mcp:write; use role:manager somente quando o agente realmente precisar criar ou atribuir registros.": { es: "Para lectura, habilita mcp:read. Para acciones, añade mcp:write; usa role:manager solo cuando el agente realmente necesite crear o asignar registros." },
  "Senha alterada. Enviamos um aviso de segurança para seu e-mail.": { es: "Contraseña cambiada. Enviamos un aviso de seguridad a tu correo." },
  "Confirme a troca pelo e-mail enviado. O endereço atual permanece ativo até a confirmação.": { es: "Confirma el cambio mediante el correo enviado. La dirección actual permanece activa hasta la confirmación." },
  "Para sua proteção, confirme a senha atual antes de definir uma nova.": { es: "Para tu protección, confirma la contraseña actual antes de definir una nueva." },
  "Senha atual": { es: "Contraseña actual" },
  "Alterando…": { es: "Cambiando…" },
  "Alterar senha": { es: "Cambiar contraseña" },
  "E-mail de acesso": { es: "Correo de acceso" },
  "E-mail atual:": { es: "Correo actual:" },
  "A troca só vale após a confirmação enviada para o novo endereço.": { es: "El cambio solo se aplica después de la confirmación enviada a la nueva dirección." },
  "Novo e-mail": { es: "Nuevo correo" },
  "Enviando confirmação…": { es: "Enviando confirmación…" },
  "Solicitar troca de e-mail": { es: "Solicitar cambio de correo" },
  "Código de verificação em duas etapas": { es: "Código de verificación en dos pasos" },
  "Ao salvar, o novo perfil alcança membros que ainda usam o padrão anterior. Configurações individuais diferentes e convites já emitidos são preservados.": { es: "Al guardar, el nuevo perfil se aplica a los miembros que todavía usan el valor anterior. Se conservan las configuraciones individuales diferentes y las invitaciones ya emitidas." },
  "Aplicar também aos membros que usam o perfil padrão atual": { es: "Aplicar también a los miembros que usan el perfil predeterminado actual" },
  "Seu acesso a esta organização foi removido": { es: "Tu acceso a esta organización fue eliminado" },
  "Esta conta não possui mais uma organização ativa. Peça um novo convite a quem administra o sistema.": { es: "Esta cuenta ya no tiene una organización activa. Solicita una nueva invitación a quien administra el sistema." },
  "Esta ação remove definitivamente o agente, suas versões e execuções. Ela não pode ser desfeita; o registro da ação permanece na auditoria.": { es: "Esta acción elimina definitivamente el agente, sus versiones y ejecuciones. No se puede deshacer; el registro de la acción permanece en la auditoría." },
  "Agente excluído definitivamente.": { es: "Agente eliminado definitivamente." },
  "Agente arquivado.": { es: "Agente archivado." },
  "Assinatura atual": { es: "Suscripción actual" },
  "Nenhuma assinatura vinculada": { es: "Ninguna suscripción vinculada" },
  "Escolha um plano na página inicial. Após a confirmação, o pagamento será conciliado com esta organização.": { es: "Elige un plan en la página inicial. Tras la confirmación, el pago se conciliará con esta organización." },
  "Alertas silenciados": { es: "Alertas silenciadas" },
  "Silenciar alertas": { es: "Silenciar alertas" },
  "Cancelar seleção": { es: "Cancelar selección" },
  "Selecionar contatos": { es: "Seleccionar contactos" },
  "Todos visíveis": { es: "Todos visibles" },
  "Excluir selecionados": { es: "Eliminar seleccionados" },
  "Excluir todos": { es: "Eliminar todos" },
  "Plano e cobrança": { es: "Plan y facturación" },
  "Pagamento recebido para processamento": { es: "Pago recibido para procesamiento" },
  "Obrigado por escolher seu plano.": { es: "Gracias por elegir tu plan." },
  "A confirmação será processada com segurança. Se você já possui uma organização, o status aparecerá em Configurações › Billing.": { es: "La confirmación se procesará de forma segura. Si ya tienes una organización, el estado aparecerá en Configuración › Facturación." },
  "Voltar ao site": { es: "Volver al sitio" },
  "Pagamentos": { es: "Pagos" },
  "Checkouts dinâmicos, sincronização Asaas e eventos recebidos.": { es: "Checkouts dinámicos, sincronización con Asaas y eventos recibidos." },
  "configurado": { es: "configurado" },
  "não configurado": { es: "no configurado" },
  "Os valores são alterados em Configurações da landing e publicados nos mesmos links.": { es: "Los valores se cambian en la configuración de la landing y se publican en los mismos enlaces." },
  "Aguardando publicação": { es: "Esperando publicación" },
  "Abrir checkout": { es: "Abrir checkout" },
